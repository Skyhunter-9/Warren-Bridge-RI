...
// Data layer for the wave radar display - mirrors ../../Sensors/sensorIngestion.ts's SensorService
...
export class RadarService {
  ...
  // whole request, matching sensorIngestion.ts's per-field fallback approach; if the request
